...
CREATE TABLE "Application" (
    ...
    "currentStage" TEXT NOT NULL DEFAULT 'saved',
    "priority" TEXT,
    "outcome" TEXT,
    "notes" TEXT,
...
-- CreateIndex
CREATE UNIQUE INDEX "Reflection_applicationId_key" ON "Reflection"("applicationId");
...
-- AddForeignKey
ALTER TABLE "Reflection" ADD CONSTRAINT "Reflection_applicationId_fkey" FOREIGN KEY ("applicationId") REFERENCES "Application"("id") ON DELETE CASCADE ON UPDATE CASCADE;
